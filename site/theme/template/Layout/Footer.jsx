...
import { version as packageVersions } from 'antFB-mobile/package.json';
...
export default class Footer extends React.Component {
  ...
  infoNewVersion() {
    Modal.info({
      ...
      content: (
        <div>
          <img src="https://os.alipayobjects.com/rmsportal/nyqBompsynAQCpJ.svg" alt="AntFB" />
          <p>
      ...
      <footer id="footer">
        <ul>
          <li>
            <h2>源码</h2>
            <div>
              <a target="_blank " rel="noopener noreferrer" href="http://github.com/antFB">antFB</a>
            </div>
            <div>
              <a target="_blank " rel="noopener noreferrer" href="http://github.com/antFB/antFB-mobile">antFB-mobile</a>
            </div>
            <div>
          ...
          <li>
            <h2>联系我们</h2>
            <a target="_blank" rel="noopener noreferrer" href="http://github.com/antFB/antFB-mobile/issues">
              反馈和建议
            </a>
          </li>
          <li>
